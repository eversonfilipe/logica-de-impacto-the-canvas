...
export const AddNoteIcon: React.FC<{ className?: string }> = ({ className }) => (
...
export const AiSparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L15 12l-2.293-2.293a1 1 0 010-1.414L15 6zm-5 14l2.293 2.293a1 1 0 001.414 0L15 18l-2.293-2.293a1 1 0 00-1.414 0L10 18z" />
    </svg>
);
...
export const EllipseIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <circle cx="12" cy="12" r="8" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} />
    </svg>
);
